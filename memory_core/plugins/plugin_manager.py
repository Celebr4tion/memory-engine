...
class PluginManager:
    ...
    async def _load_plugin_info(self, plugin_json_path: str, plugin_dir: str) -> Optional[PluginInfo]:
    ...
    async def _inspect_python_file(self, file_path: str) -> Optional[PluginInfo]:
        ...
        try:
            ...
            for name, obj in inspect.getmembers(module, inspect.isclass):
                if (hasattr(obj, '__plugin_info__') and 
    ...
    async def _load_plugin_instance(self, plugin_info: PluginInfo) -> Optional[Any]:
        ...
        try:
            ...
            if not issubclass(plugin_class, PluginInterface):
                logger.error(f"Plugin class {plugin_info.class_name} does not implement PluginInterface")
                return None
    ...
    def get_plugins_by_type(self, plugin_type: str) -> List[Any]:
        ...
        return [
            plugin for plugin_name, plugin in self._loaded_plugins.items()
...
def plugin(name: str = None, version: str = "1.0.0", description: str = "", 
          author: str = "", plugin_type: str = "unknown", 
