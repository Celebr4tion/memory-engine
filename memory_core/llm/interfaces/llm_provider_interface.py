...
{{"category_name": confidence_score, ...}}"""
        ...
        response = await self.generate_completion(prompt, LLMTask.TEXT_CLASSIFICATION, **kwargs)
    ...
    async def summarize_text(self, text: str, max_length: Optional[int] = None, **kwargs) -> str:
        """
        ...
        response = await self.generate_completion(prompt, LLMTask.SUMMARIZATION, **kwargs)
