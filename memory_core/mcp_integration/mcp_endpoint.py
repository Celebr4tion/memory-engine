...
class MemoryEngineMCP:
    ...
    def ingest_raw_text(self, raw_text: str, source_label: str = "MCP Input") -> Dict[str, Any]:
        ...
        try:
            ...
            if not units:
                ...
                return {"status": "no_knowledge_extracted", "created_or_merged_node_ids": []}
            ...
            if len(node_ids) > 1:
                ...
                relationships = analyze_and_create_relationships(
                    node_ids, self.engine.storage, self.embedding_manager
                )
            ...
            return {"status": "error", "message": str(e), "created_or_merged_node_ids": []}
    ...
    def search_text(self, query_text: str, top_k: int = 5) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "success", "query": query_text, "results": results}
    ...
    def update_node_rating(self, node_id: str, new_rating: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if "confirmation" in new_rating or "contradiction" in new_rating:
                ...
                truthfulness = min(
                    1.0,
                    max(0.0, node.rating_truthfulness + 0.2 * confirmation - 0.2 * contradiction),
                )
        ...
        try:
            ...
            if action == "ingest_text":
                ...
                if "node_id" not in command:
                    return {"status": "error", "message": "Missing required field: 'node_id'"}
