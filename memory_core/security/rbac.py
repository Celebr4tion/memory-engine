...
class RBACManager:
    ...
    def _initialize_system_permissions(self) -> None:
        ...
        system_permissions = [
            ...
            (
                "knowledge_search",
                "Search Knowledge",
                PermissionType.KNOWLEDGE_SEARCH,
            ...
            (
                ...
                PermissionType.RELATIONSHIP_CREATE,
                "Create relationships between nodes",
            ),
            (
                "relationship_read",
                "Read Relationships",
                PermissionType.RELATIONSHIP_READ,
                "Read relationship information",
            ),
            (
                "relationship_update",
                "Update Relationships",
                PermissionType.RELATIONSHIP_UPDATE,
                "Update existing relationships",
            ),
            (
                "relationship_delete",
                "Delete Relationships",
                PermissionType.RELATIONSHIP_DELETE,
                "Delete relationships",
            ),
            # System permissions
            (
            ...
            (
                "privacy_manage",
                "Manage Privacy",
                PermissionType.PRIVACY_MANAGE,
                "Manage privacy levels and access control",
            ),
            (
                "security_audit",
                "Security Auditing",
                PermissionType.SECURITY_AUDIT,
                "Access security audit logs",
            ),
            (
                "encryption_manage",
                "Manage Encryption",
                PermissionType.ENCRYPTION_MANAGE,
        ...
        for perm_id, name, perm_type, description in system_permissions:
            permission = Permission(
                permission_id=perm_id, name=name, type=perm_type, description=description
            )
    ...
    def _initialize_system_roles(self) -> None:
        ...
        knowledge_reader = Role(
            ...
            permissions={"knowledge_read", "knowledge_search", "relationship_read"},
            is_system_role=True,
        )
        ...
        monitor = Role(
            ...
            permissions={"system_monitor", "security_audit", "knowledge_read", "relationship_read"},
            is_system_role=True,
        )
    ...
    def check_permission(
        self, user_roles: Set[str], permission_type: PermissionType, resource: Optional[str] = None
    ) -> bool:
        """
    ...
    def get_effective_permissions(
        self, user_roles: Set[str], resource: Optional[str] = None
