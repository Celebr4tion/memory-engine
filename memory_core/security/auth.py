...
class AuthManager:
    ...
    def __init__(self, secret_key: Optional[str] = None):
        ...
        self.secret_key = secret_key or self.config.get('security.secret_key', secrets.token_urlsafe(32))
    ...
    def authenticate(self, username: str, password: str) -> Optional[User]:
        ...
        if not self.verify_password(password, user.password_hash):
            ...
            logger.warning(f"Authentication failed: Invalid password for '{username}' (attempt {user.failed_login_attempts})")
            return None
