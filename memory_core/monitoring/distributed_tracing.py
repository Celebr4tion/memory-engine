...
class MemoryEngineTracer:
    ...
    def __init__(self, service_name: str = "memory-engine",
...
class TracingIntegration:
    ...
    def instrument_storage_layer(self, storage):
        ...
        self.logger.info("Storage layer instrumented with tracing", 
                        storage_type=storage.__class__.__name__)
...
def initialize_tracing(service_name: str = "memory-engine",
                      jaeger_endpoint: Optional[str] = None,
                      enable_console_export: bool = False) -> MemoryEngineTracer:
    """
