...
class NaturalLanguageQueryProcessor:
    ...
    async def process_query(self, query: str, context: Optional[str] = None) -> ParsedQuery:
        ...
        self.logger.info(
            f"Parsed query intent: {parsed_query.intent}, type: {parsed_query.query_type}"
        )
        return parsed_query
    ...
    def _combine_parsing_results(
        self, original_query: str, basic: Dict[str, Any], llm: Dict[str, Any]
    ) -> ParsedQuery:
        """
