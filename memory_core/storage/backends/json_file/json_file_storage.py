...
class JsonFileStorage(GraphStorageInterface):
    ...
    async def delete_node(self, node_id: str) -> bool:
        ...
        if node_id in self._node_edges:
            edges_to_delete = list(self._node_edges[node_id]["outgoing"]) + list(
    ...
    async def find_neighbors(
        ...
        neighbor_edges = []
        all_edge_ids = self._node_edges[node_id]["outgoing"] | self._node_edges[node_id]["incoming"]
        ...
        try:
            ...
            for edge_id in node2_outgoing:
                ...
                if edge_data and edge_data["to_id"] != node_id1:  # Avoid self-loops
                    ...
                    await self.create_edge(
                        node_id1, edge_data["to_id"], edge_data["relation_type"], properties
                    )
                # Delete old edge
                await self.delete_edge(edge_id)
            ...
            for edge_id in node2_incoming:
                ...
                if edge_data and edge_data["from_id"] != node_id1:  # Avoid self-loops
                    ...
                    await self.create_edge(
                        edge_data["from_id"], node_id1, edge_data["relation_type"], properties
                    )
                # Delete old edge
                await self.delete_edge(edge_id)
        ...
        try:
            ...
            if self.index_file.exists():
                with open(self.index_file, "r") as f:
                    ...
                    self._content_index = {
                        k: set(v) for k, v in index_data.get("content_index", {}).items()
                    }
