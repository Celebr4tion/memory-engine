...
class KnowledgeNode:
    ...
    def __init__(
        ...
        self.source = source
        self.creation_timestamp = creation_timestamp if creation_timestamp is not None else time.time()
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            self.rating_richness == other.rating_richness and
            self.rating_truthfulness == other.rating_truthfulness and
            self.rating_stability == other.rating_stability
        )
