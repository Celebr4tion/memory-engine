...
class TestKnowledgeEngine:
    ...
    def test_initialization_with_versioning(self, MockVersionedAdapter, MockRevisionManager, 
                                          MockGraphAdapter, MockJanusStorage):
    ...
    @patch('memory_core.core.knowledge_engine.RevisionManager')
    @patch('memory_core.core.knowledge_engine.VersionedGraphAdapter')
    def test_initialization_without_versioning(self, MockVersionedAdapter, MockRevisionManager, 
                                             MockGraphAdapter, MockJanusStorage):
    ...
    @patch('memory_core.core.knowledge_engine.RevisionManager')
    @patch('memory_core.core.knowledge_engine.VersionedGraphAdapter')
    def test_connect_disconnect(self, MockVersionedAdapter, MockRevisionManager, 
                               MockGraphAdapter, MockJanusStorage):
    ...
    @patch('memory_core.core.knowledge_engine.RevisionManager')
    @patch('memory_core.core.knowledge_engine.VersionedGraphAdapter')
    def test_save_node(self, MockVersionedAdapter, MockRevisionManager, 
                      MockGraphAdapter, MockJanusStorage):
        """Test saving a node."""
        # Setup
    ...
    @patch('memory_core.core.knowledge_engine.RevisionManager')
    @patch('memory_core.core.knowledge_engine.VersionedGraphAdapter')
    def test_save_relationship(self, MockVersionedAdapter, MockRevisionManager, 
                              MockGraphAdapter, MockJanusStorage):
    ...
    @patch('memory_core.core.knowledge_engine.RevisionManager')
    @patch('memory_core.core.knowledge_engine.VersionedGraphAdapter')
    def test_versioning_methods_with_versioning_disabled(self, MockVersionedAdapter, MockRevisionManager, 
                                                       MockGraphAdapter, MockJanusStorage):
