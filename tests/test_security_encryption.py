...
class TestEncryptionManager:
    ...
    def test_key_generation_aes(self):
        ...
        key = self.encryption_manager.generate_key(
            EncryptionType.AES_256_GCM, EncryptionScope.USER_DATA, expires_in_days=30
        )
    ...
    def test_key_generation_fernet(self):
        ...
        key = self.encryption_manager.generate_key(
            EncryptionType.FERNET, EncryptionScope.SESSION_DATA
        )
    ...
    def test_key_generation_rsa(self):
        ...
        key = self.encryption_manager.generate_key(
            EncryptionType.RSA_2048, EncryptionScope.API_KEYS
        )
    ...
    def test_string_encryption_decryption(self):
        ...
        encrypted_b64 = self.encryption_manager.encrypt_string(
            test_string, EncryptionScope.USER_DATA
        )
    ...
    def test_data_encryption_decryption_aes(self):
        ...
        # Encrypt
        encrypted_data = self.encryption_manager.encrypt(test_data, EncryptionScope.USER_DATA)
    ...
    def test_data_encryption_decryption_fernet(self):
        ...
        # Encrypt
        encrypted_data = self.encryption_manager.encrypt(test_data, EncryptionScope.SESSION_DATA)
    ...
    def test_data_encryption_decryption_rsa_small(self):
        ...
        # Encrypt
        encrypted_data = self.encryption_manager.encrypt(test_data, EncryptionScope.API_KEYS)
    ...
    def test_key_expiration_checking(self):
        ...
        expired_key = self.encryption_manager.generate_key(
            EncryptionType.AES_256_GCM, EncryptionScope.USER_DATA
        )
    ...
    def test_encryption_with_specific_key(self):
        ...
        encrypted_data = self.encryption_manager.encrypt(
            test_data, EncryptionScope.USER_DATA, key_id=additional_key.key_id
        )
    ...
    def test_invalid_key_id_encryption(self):
        ...
        with pytest.raises(ValueError, match="Key .* not found"):
            self.encryption_manager.encrypt(
                test_data, EncryptionScope.USER_DATA, key_id="nonexistent-key"
            )
    ...
    def test_decryption_with_missing_key(self):
        ...
        encrypted_data = EncryptedData(
            data=b"some_data", algorithm=EncryptionType.AES_256_GCM, key_id="missing-key"
        )
