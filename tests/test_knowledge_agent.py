...
class TestKnowledgeAgent:
    ...
    def test_create_knowledge_agent_function(self):
        ...
        try:
            ...
            agent = create_knowledge_agent(
                host=self.test_host, port=self.test_port, model="gemini-2.0-flash-thinking-exp"
            )
    ...
    def test_knowledge_agent_imports(self):
        ...
        for method_name in expected_methods:
            assert hasattr(
                KnowledgeAgent, method_name
            ), f"KnowledgeAgent missing method: {method_name}"
...
class TestKnowledgeAgentIntegration:
    ...
    async def test_extract_knowledge_integration(self):
        ...
        try:
            ...
            with patch(
                "memory_core.agents.knowledge_agent.extract_knowledge_units"
            ) as mock_extract:
...
class TestKnowledgeAgentFunctionality:
    ...
    def test_create_knowledge_agent_parameters(self):
        ...
        for param in expected_params:
            assert (
                param in params
            ), f"Expected parameter '{param}' not found in create_knowledge_agent"
