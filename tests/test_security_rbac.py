...
from memory_core.security.rbac import RBACManager, Role, Permission, PermissionType
...
class TestRole:
    ...
    def test_role_permission_management(self):
        ...
        role = Role(role_id="role-123", name="Test Role", description="Test role")
    ...
    def test_role_parent_management(self):
        ...
        role = Role(role_id="role-123", name="Child Role", description="Child role")
...
class TestRBACManager:
    ...
    def test_role_permission_management(self):
        ...
        role = self.rbac_manager.create_role(name="Test Role", description="Test role")
        ...
        result = self.rbac_manager.add_permission_to_role(
            role.role_id, test_permission.permission_id
        )
    ...
    def test_role_hierarchy_permissions(self):
        ...
        parent_permissions = set(
            list(perm.permission_id for perm in self.rbac_manager.list_permissions())[:2]
        )
        parent_role = self.rbac_manager.create_role(
            name="Parent Role", description="Parent role", permissions=parent_permissions
        )

        # Create child role with different permissions
        child_permissions = set(
            list(perm.permission_id for perm in self.rbac_manager.list_permissions())[2:4]
        )
        ...
        effective_permissions = self.rbac_manager.get_role_permissions(
            child_role.role_id, include_inherited=True
        )
        ...
        direct_permissions = self.rbac_manager.get_role_permissions(
            child_role.role_id, include_inherited=False
        )
    ...
    def test_permission_checking(self):
        ...
        knowledge_read_perms = [
            perm
            for perm in self.rbac_manager.list_permissions()
        ...
        has_permission = self.rbac_manager.check_permission(
            user_roles, PermissionType.KNOWLEDGE_READ
        )
        assert has_permission is True

        # Should not have knowledge create permission
        has_permission = self.rbac_manager.check_permission(
            user_roles, PermissionType.KNOWLEDGE_CREATE
        )
    ...
    def test_effective_permissions(self):
        ...
        role = self.rbac_manager.create_role(
            name="Test Role", description="Test role", permissions=permission_ids
        )
    ...
    def test_role_hierarchy_validation(self):
        ...
        # Create roles
        role_a = self.rbac_manager.create_role(name="Role A", description="Role A")

        role_b = self.rbac_manager.create_role(
            name="Role B", description="Role B", parent_roles={role_a.role_id}
        )
    ...
    def test_delete_permission(self):
        ...
        role = self.rbac_manager.create_role(
            name="Test Role", description="Test role", permissions={permission.permission_id}
        )
    ...
    def test_delete_role(self):
        """Test deleting roles."""
        # Create custom role
        role = self.rbac_manager.create_role(name="Custom Role", description="Custom role")
    ...
    def test_role_by_name_lookup(self):
        ...
        # Create custom role
        role = self.rbac_manager.create_role(name="Unique Role Name", description="Unique role")
