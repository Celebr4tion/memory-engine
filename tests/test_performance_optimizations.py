...
from memory_core.processing.async_queue_processor import AsyncProcessingQueue, QueueTask, TaskPriority
...
class TestBulkIngestionProcessor:
    ...
    def test_process_single_document(self):
        ...
        with patch('memory_core.ingestion.bulk_processor.process_extracted_units', return_value=["node1", "node2"]):
    ...
    def test_process_documents_batch(self):
        ...
        with patch('memory_core.ingestion.bulk_processor.process_extracted_units', return_value=["node1"]):
    ...
    def test_process_documents_with_failures(self):
        ...
        documents = [
            ...
            BulkDocument(id="bad_doc", content="", source_label="test")  # Empty content should fail
        ]
...
class TestPerformanceRegressionTester:
    ...
    def setup_method(self):
        ...
        self.tester = PerformanceRegressionTester(
            baseline_storage_path="test_baselines.json",
