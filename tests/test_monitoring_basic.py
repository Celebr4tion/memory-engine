...
class TestHealthChecker:
    ...
    async def test_system_resource_checks(self):
        ...
        assert memory_health.status in [HealthStatus.HEALTHY, HealthStatus.DEGRADED, HealthStatus.UNHEALTHY]
        assert disk_health.status in [HealthStatus.HEALTHY, HealthStatus.DEGRADED, HealthStatus.UNHEALTHY]
