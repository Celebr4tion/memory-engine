...
from memory_core.synthesis.knowledge_synthesis_engine import (
    KnowledgeSynthesisEngine, SynthesisRequest, SynthesisTaskType, SynthesisMode,
    ComprehensiveSynthesisResult
)
from memory_core.synthesis.question_answering import (
    QuestionAnsweringSystem, SynthesizedAnswer, QuestionType, QuestionContext, AnswerSource
)
from memory_core.synthesis.insight_discovery import (
    InsightDiscoveryEngine, InsightReport, Pattern, Trend, Anomaly,
    PatternType, TrendType, AnomalyType
)
from memory_core.synthesis.perspective_analysis import (
    PerspectiveAnalysisEngine, PerspectiveAnalysisReport, Perspective,
    PerspectiveType, ConsensusLevel
)
...
class TestInsightDiscoveryEngine:
    ...
    def test_pattern_detection_types(self, insight_engine):
        ...
        result = insight_engine.discover_insights(
            domain="technology",
