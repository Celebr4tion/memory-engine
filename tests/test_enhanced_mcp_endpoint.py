...
class TestAdvancedGraphQueries:
    ...
    def test_pattern_matching_basic(self, enhanced_mcp):
        ...
        pattern = {
            "nodes": {"content_contains": "python programming"},
            "max_results": 5
        }
...
class TestKnowledgeSynthesis:
    ...
    def test_answer_question_success(self, enhanced_mcp):
        ...
        enhanced_mcp.multi_hop_traversal = Mock(return_value={
            "status": "success",
...
class TestBulkOperations:
    ...
    def test_add_to_bulk_ingestion_success(self, enhanced_mcp):
        ...
        with patch('memory_core.mcp_integration.enhanced_mcp_endpoint.extract_knowledge_units') as mock_extract, \
             patch('memory_core.mcp_integration.enhanced_mcp_endpoint.process_extracted_units') as mock_process:
    ...
    def test_export_subgraph_json(self, enhanced_mcp):
        ...
        enhanced_mcp.engine.get_node.side_effect = [node1, node2]
        enhanced_mcp.engine.get_outgoing_relationships.return_value = [
            Mock(from_id="node1", to_id="node2", relation_type="relates_to", 
                 confidence_score=0.8, timestamp=time.time())
        ]
...
class TestCommandRouting:
    ...
    def test_execute_mcp_command_answer_question(self, enhanced_mcp):
        ...
        enhanced_mcp.answer_question = Mock(return_value={"status": "success", "answer": "Test answer"})
    ...
    def test_execute_mcp_command_bulk_operations(self, enhanced_mcp):
        ...
        enhanced_mcp.start_bulk_ingestion = Mock(return_value={"status": "success", "operation_id": "123"})
