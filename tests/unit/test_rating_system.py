...
class TestUpdateRating(unittest.TestCase):
    ...
    def test_update_all_ratings(self):
        ...
        evidence = {"confirmation": 0.5, "richness": 1.0, "stability": -0.5}
        result = update_rating("test_node_123", evidence, self.mock_storage)
    ...
    def test_boundary_values(self):
        ...
        evidence = {"confirmation": 1.0, "richness": 1.0, "stability": 1.0}
        ...
        evidence = {"contradiction": 1.0, "richness": -1.0, "stability": -1.0}
    ...
    def test_handles_missing_ratings_in_node(self):
        ...
        evidence = {"confirmation": 0.5, "richness": 0.5, "stability": 0.5}
