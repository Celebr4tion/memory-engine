...
class TestConfigManager:
    ...
    def test_yaml_config_loading(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            test_config = {
                ...
                "janusgraph": {"host": "test-host", "port": 9999},
            }
    ...
    def test_json_config_loading(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            test_config = {
                "environment": "staging",
                "embedding": {"model": "custom-embedding-model", "dimension": 1024},
                "llm": {"temperature": 0.8},
            }
    ...
    def test_configuration_validation_success(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            env_vars = {"GOOGLE_API_KEY": "valid-api-key", "DATABASE_URL": "sqlite:///test.db"}
