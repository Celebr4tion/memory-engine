...
class TestQualityBasedRanking:
    ...
    def test_ranker_with_quality_engine(self, mock_quality_engine, sample_query_results):
        ...
        request = QueryRequest(
            query="machine learning algorithms", query_type=QueryType.SEMANTIC_SEARCH
        )
    ...
    def test_quality_score_caching(self, mock_quality_engine, sample_query_results):
        ...
        request = QueryRequest(query="machine learning", query_type=QueryType.SEMANTIC_SEARCH)
...
class TestQualityEnhancedQueryExecution:
    ...
    def test_enhance_query_response(
        self, mock_engine_class, mock_quality_engine, sample_query_results
    ):
    ...
    def test_ranking_with_context_relevance(self, mock_quality_engine, sample_query_results):
        ...
        sample_query_results[1].content = (
            "machine learning algorithms comprehensive analysis detailed"
        )

        request = QueryRequest(
            query="comprehensive machine learning analysis", query_type=QueryType.SEMANTIC_SEARCH
        )
...
class TestPerformanceAndScalability:
    ...
    def test_large_result_set_ranking(self, mock_quality_engine):
        ...
        request = QueryRequest(query="test query", query_type=QueryType.SEMANTIC_SEARCH)
    ...
    def test_quality_assessment_error_handling(self, sample_query_results):
        ...
        failing_quality_engine.get_quality_score.side_effect = Exception(
